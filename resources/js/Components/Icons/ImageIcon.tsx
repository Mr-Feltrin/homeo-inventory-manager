...
const ImageIcon = ({ ...props }: SVGProps<SVGSVGElement>) => {
    return (
        <svg {...props} className={props.className ?? "w-10 h-10 text-gray-500 dark:text-gray-400"} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 20" data-darkreader-inline-fill="">
